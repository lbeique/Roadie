...
import { confirmPassword } from "../../auth/auth";
  ...
  if (success) {
    return (
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-white-700">Reset password</h2>
        <p className="block text-center text-sm font-medium leading-6 text-white-700">Your password has been reset successfully!</p>
